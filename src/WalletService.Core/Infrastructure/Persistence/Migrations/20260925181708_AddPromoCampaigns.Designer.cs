...
namespace HiWallet.WalletService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925181708_AddPromoCampaigns")]
    partial class AddPromoCampaigns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HiWallet.WalletService.Domain.Balances.LedgerBalance", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            LedgerAccountId = new Guid("a0000000-0000-4000-8000-000000000007"),
                            FundType = "cash",
                            Balance = 0m,
                            Currency = "TRY",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            LedgerAccountId = new Guid("a0000000-0000-4000-8000-000000000008"),
                            FundType = "cash",
                            Balance = 0m,
                            Currency = "TRY",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("HiWallet.WalletService.Domain.Promos.PromoGrant", b =>
                {
                    ...
                    b.Property<Guid?>("FunderLedgerAccountId")
                        .HasColumnType("uuid")
                        .HasColumnName("funder_ledger_account_id");
                    ...
                    b.HasIndex("FunderLedgerAccountId", "Currency")
                    ...
                    b.ToTable("promo_grants", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_promo_grants_funder_account", "(funder = 'business') = (funder_ledger_account_id IS NOT NULL)");

                            t.HasCheckConstraint("ck_promo_grants_scope", "scope IN ('all_businesses','selected_businesses')");
                        });
                });

            modelBuilder.Entity("HiWallet.WalletService.Domain.Promos.PromoGrantMerchant", b =>
                {
                    b.Property<Guid>("GrantId")
                        .HasColumnType("uuid")
                        .HasColumnName("grant_id");
                    ...
                    b.HasKey("GrantId", "AccountId")
                        .HasName("pk_promo_grant_merchants");

                    b.HasIndex("AccountId")
                        .HasDatabaseName("ix_promo_grant_merchants_account");

                    b.ToTable("promo_grant_merchants", (string)null);
                });
            ...
            modelBuilder.Entity("HiWallet.WalletService.Domain.Promos.PromoGrant", b =>
                {
                    ...
                    b.HasOne("HiWallet.WalletService.Domain.Ledger.LedgerAccount", null)
                        .WithMany()
                        .HasForeignKey("FunderLedgerAccountId", "Currency")
                        .HasPrincipalKey("Id", "Currency")
                        .OnDelete(DeleteBehavior.Restrict)
