...
/// <summary>
/// <c>POST /v1/transfers</c> response'u. Verilen söz "gönderdim" DEĞİL, "aldım":
/// <c>status</c> kabul anında <c>pending</c>.
/// </summary>
/// <param name="Replayed">
/// Aynı idempotency anahtarıyla ikinci request. Transfer TEKRARLANMADI, mevcut kayıt
...
/// <summary>
/// <c>GET /v1/transfers/{bankReference}</c> response'u. Mutabakat taramasının okuduğu şey.
/// </summary>
